    ...
    <footer class="footer mt-6">
      <div class="bg-gray-light">
        ...
        >
          ...
          >
            <li class="mr-3">
              <a href="mailto:contact@lgtm.us" style="color: #959da5;"
                ><svg
                  height="20"
            ...
            <li>
              <a
                href="https://github.com/ittus/lgtm.us"
                style="color: #959da5;"
                target="_blank"
                ><svg
                  height="20"
          ...
          <ul class="list-style-none d-flex text-gray">
            <li class="mr-3">© 2019 Lgtm.us</li>
            <li>
              <a
                href="https://www.buymeacoffee.com/8buMYCOog"
                target="_blank"
                class="link-gray"
                >Support us</a
              >
...
.content-wrap {
  padding-bottom: 4.25rem; /* Footer height */
}
